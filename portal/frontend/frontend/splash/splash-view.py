    ...
    sec_teacher_buttons = [
        ...
        button(name="Google Drive", externalid=-9, size="large", color="cyan", url="https://drive.google.com", icon="files-o", id="", 
            ...
            'items': [
                ...
                menu_item(icon="folder", display="Reporting Guidelines Semester 2", url="https://docs.google.com/document/d/1TtMaISuhQTd-MwO8eWYvfky0mQNuWK3Ui7LwmmMOanU/edit?ts=5ab8d445")
            ]
            }),
